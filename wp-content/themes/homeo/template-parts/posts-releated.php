<?php
    $relate_count = homeo_get_config('number_blog_releated', 2);
    $relate_columns = homeo_get_config('releated_blog_columns', 2);
...
<div class="related-posts">
    <h4 class="title">
        <span><?php esc_html_e( 'Related Posts', 'homeo' ); ?></span>
    </h4>
