jQuery(document).ready(function($){
    ...
    function show_hide_property_setting(val) {
        if ( val == 'page-properties.php' ) {
            ...
            if ( !$('#apus_page_layout_type').val() || $('#apus_page_layout_type').val() == 'default' ) {
                $('.cmb2-id-apus-page-elementor-template').show();
            } else {
                $('.cmb2-id-apus-page-elementor-template').hide();
            }
    ...
    $("body").on("wp_realestate_all_loading_icons", function(){
        homeo_get_awesome_icons();
        homeo_get_flaticon_icons();
        homeo_get_themify_icons();
    });

    function homeo_get_awesome_icons() {
    ...
    function homeo_get_flaticon_icons() {
        ...
        for( var i=0; i < files.length; i++ ){
            css = Array.prototype.map.call( files[i].sheet.cssRules, homeo_css_text ).join('\n');
    ...
    function homeo_get_themify_icons() {
