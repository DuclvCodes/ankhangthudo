...
class WP_RealEstate_Taxonomy_Agency_Location{
	...
	public static function definition() {
		...
		$rewrite_slug = get_option('wp_realestate_agency_location_slug');
		if ( empty($rewrite_slug) ) {
			$rewrite_slug = _x( 'agency-location', 'Agency location slug - resave permalinks after changing this', 'wp-realestate' );
		}
		$rewrite = array(
			'slug'         => $rewrite_slug,
			'with_front'   => false,
		...
		register_taxonomy( 'agency_location', 'agency', array(
			'labels'            => apply_filters( 'wp_realestate_taxomony_agency_location_labels', $labels ),
			'hierarchical'      => true,
			'rewrite'           => $rewrite,
			'public'            => true,
			'show_ui'           => true,
...
WP_RealEstate_Taxonomy_Agency_Location::init();